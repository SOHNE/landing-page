...
import { copy, length, vec2, add, sub, divN, mulN } from '../modules/play.core/src/modules/vec2.js'
import { smoothstep } from '../modules/play.core/src/modules/num.js'

export const settings = { fps : 60, color: '#393939' }
