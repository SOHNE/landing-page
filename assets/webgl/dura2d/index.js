...
// include: /home/zschzen/Documentos/Git/emsdk/upstream/emscripten/src/emrun_prejs.js
/**
 * @license
...
// end include: /home/zschzen/Documentos/Git/emsdk/upstream/emscripten/src/emrun_prejs.js
...
var ASM_CONSTS = {
  403620: () => { if (document.fullscreenElement) return 1; },  
 403666: () => { return document.getElementById('canvas').width; },  
 403718: () => { return parseInt(document.getElementById('canvas').style.width); },  
 403786: () => { document.exitFullscreen(); },  
 403813: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 403886: () => { if (document.fullscreenElement) return 1; },  
 403932: () => { return document.getElementById('canvas').width; },  
 403984: () => { return screen.width; },  
 404009: () => { document.exitFullscreen(); },  
 404036: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 404169: () => { if (document.fullscreenElement) return 1; },  
 404215: () => { return document.getElementById('canvas').width; },  
 404267: () => { return parseInt(document.getElementById('canvas').style.width); },  
 404335: () => { if (document.fullscreenElement) return 1; },  
 404381: () => { return document.getElementById('canvas').width; },  
 404433: () => { return screen.width; },  
 404458: () => { if (document.fullscreenElement) return 1; },  
 404504: () => { return document.getElementById('canvas').width; },  
 404556: () => { return screen.width; },  
 404581: () => { document.exitFullscreen(); },  
 404608: () => { if (document.fullscreenElement) return 1; },  
 404654: () => { return document.getElementById('canvas').width; },  
 404706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 404774: () => { document.exitFullscreen(); },  
 404801: () => { return screen.width; },  
 404826: () => { return screen.height; },  
 404852: () => { return window.screenX; },  
 404879: () => { return window.screenY; },  
 404906: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 404959: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 405030: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 405087: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 405158: () => { if (document.fullscreenElement) return 1; },  
 405204: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 405251;
var ___stop_em_js = Module['___stop_em_js'] = 405324;
...
// include: /home/zschzen/Documentos/Git/emsdk/upstream/emscripten/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
...
// end include: /home/zschzen/Documentos/Git/emsdk/upstream/emscripten/src/emrun_postjs.js
